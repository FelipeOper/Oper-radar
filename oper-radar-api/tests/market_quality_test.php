...
foreach ([100, 110, 120, 130, 140, 999] as $preco) {
    $registros[] = ['preco' => $preco, 'preco_fipe' => null, 'titulo' => '', 'preco_texto_bruto' => '', 'ano' => 2020, 'carroceria' => '', 'tipo' => 'Caminhao'];
}
...
$semFipe = [['preco' => 100000, 'preco_fipe' => 0, 'titulo' => '', 'preco_texto_bruto' => '', 'ano' => 2020, 'carroceria' => '', 'tipo' => 'Caminhao']];
verifica(mercado_desvio_fipe_medio_pct($semFipe) === null, 'desvio fipe ignora registro sem fipe');
$reg = fn($preco) => ['preco' => $preco, 'preco_fipe' => 100000, 'titulo' => '', 'preco_texto_bruto' => '', 'ano' => 2020, 'carroceria' => '', 'tipo' => 'Caminhao'];
$extremo = ['preco' => 19900, 'preco_fipe' => 315000, 'titulo' => 'MB 1017', 'preco_texto_bruto' => 'R$ 19.900', 'ano' => 2020, 'carroceria' => '', 'tipo' => 'Caminhao']; // rejeitado (extremo FIPE)
...
$comAno = fn($preco, $ano) => ['preco' => $preco, 'preco_fipe' => 100000, 'titulo' => '', 'preco_texto_bruto' => '', 'ano' => $ano, 'carroceria' => '', 'tipo' => 'Caminhao'];
...
verifica(mercado_carroceria_comparavel_fipe(['carroceria' => '', 'tipo' => 'Caminhao']) === true, 'carroceria vazia comparavel');
...
verifica(mercado_carroceria_comparavel_fipe(['carroceria' => 'Caçamba Basculante', 'tipo' => 'Caminhao']) === false, 'cacamba nao comparavel');
...
verifica(mercado_carroceria_comparavel_fipe(['carroceria' => 'Cavalo Mecânico com Baú']) === false, 'texto misto cavalo+bau nao comparavel');
verifica(mercado_carroceria_comparavel_fipe(['carroceria' => 'Chassi + Munck']) === false, 'texto misto chassi+munck nao comparavel');
verifica(mercado_tipo_comparavel_fipe(['tipo' => 'Caminhao']) === true, 'tipo caminhao comparavel');
verifica(mercado_tipo_comparavel_fipe(['tipo' => 'Carreta']) === false, 'carreta nao comparavel');
...
verifica(strpos($sqlCarroceria, "a.tipo='Caminhao'") !== false && strpos($sqlCarroceria, "LIKE 'CAVALO MEC%NICO'") !== false && strpos($sqlCarroceria, "IN ('CHASSIS','CHASSI')") !== false, 'sql carroceria: tipo e valores canonicos');
verifica(strpos($sqlCarroceria, "'%CAVALO%'") === false, 'sql carroceria nao usa mais LIKE amplo');
