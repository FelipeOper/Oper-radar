...
foreach ([-10, -5, 0, 5, 10] as $pct) {
    $linhas[] = ['preco' => 100000 * (1 + $pct / 100), 'preco_fipe' => 100000,
        'titulo' => 'Caminhao', 'preco_texto_bruto' => '', 'fipe_match_status' => 'confirmado', 'ano' => 2020, 'carroceria' => '', 'tipo' => 'Caminhao'];
}
...
$antiga = [];
foreach ([1990, 1995, 2000, 2004, 2005] as $ano) $antiga[] = ['preco' => 300000, 'preco_fipe' => 100000, 'titulo' => 'VW', 'ano' => $ano, 'carroceria' => '', 'tipo' => 'Caminhao', 'fipe_match_status' => 'confirmado'];
...
foreach ([2016, 2017, 2018, 2019, 2020] as $ano) $antiga[] = ['preco' => 101000, 'preco_fipe' => 100000, 'titulo' => 'VW', 'ano' => $ano, 'carroceria' => '', 'tipo' => 'Caminhao', 'fipe_match_status' => 'confirmado'];
...
$equipada = [];
foreach ([2018, 2019, 2020, 2021, 2022] as $ano) $equipada[] = ['preco' => 150000, 'preco_fipe' => 100000, 'titulo' => 'VW', 'ano' => $ano, 'carroceria' => 'Caçamba Basculante', 'tipo' => 'Caminhao', 'fipe_match_status' => 'confirmado'];
...
foreach ($equipada as &$l) $l['carroceria'] = 'Cavalo Mecânico'; $l['tipo'] = 'Caminhao';
unset($l);
