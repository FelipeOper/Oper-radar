...
$precosAtivos = concorrente_linhas($conn, "SELECT a.preco, a.titulo, a.preco_texto_bruto,
    a.fipe_match_status, COALESCE(a.ano_final,a.ano_inicial) ano, a.carroceria, f.preco preco_fipe FROM anuncio a LEFT JOIN fipe_preco f ON f.id=a.fipe_preco_id
