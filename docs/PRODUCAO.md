...
## Release 2.4 — frontend (beta e produção): Minha Loja no layout da DEMO — 25/09/2026 (PUBLICADO ~10h40; bundle conferido, verificação autenticada pendente de login)
